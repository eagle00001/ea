...
public class MailBoxMsg implements Serializable {
	...
	private String[] ccMailAddressArr; //抄送多个邮件地址
	
	public String[] getCcMailAddressArr() {
		return ccMailAddressArr;
	}
	public void setCcMailAddressArr(String[] ccMailAddressArr) {
		this.ccMailAddressArr = ccMailAddressArr;
	}
