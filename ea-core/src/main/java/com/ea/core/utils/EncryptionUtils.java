...
//		System.out.println(MD5(md5Src));
		//加密
		String key = "DESDataSourcecProxy";
		SecretKey dsKey = EncryptionUtils.createDESSecretKey(key);
		String encryptPwd = EncryptionUtils.encryptToDES(dsKey,"iot_app");
		System.out.println("encrypt pwd is "+encryptPwd);
		//解密
		String originPwd = decryptByDES(dsKey, encryptPwd);
		System.out.println("origin pwd is "+originPwd);
	}
	/**
	 * MD5加密
	 * @param str
