...
public interface HttpClientService {
	...
	/**
	 * @param httpUrl
	 * @param paramsValPairT
	 * @return
	 */
	public <T> T httpClientPost(String httpUrl,Map<String,String> paramsValPair,Class<T> t);
	/**
	 * @param httpUrl
	 * @param paramsValPair
	 * @param headerMap
	 ...
	 * @return
	 */
	public <T> T httpClientPost(String httpUrl,Map<String,String> paramsValPair,Map<String,String> headerMap,Class<T> t);
	/**
	 * 
	 * @param httpUrl
	 * @return
